...
각 에이전트 완료 후: lint/test 통과 확인 → commit → push → PR 생성.
...
3. 디렉토리 구조 생성 (CLAUDE.md Directory Structure 참조):
   - `src/pdf/` — interfaces (IPdfExtractor + PDF_EXTRACTOR token, IPdfGenerator + PDF_GENERATOR token), services (stub), dto (stub), controller (stub, Phase 3+), module
...
8. `README.md` — 프로젝트 소개, CLI 사용법, Docker 사용법, Phase 로드맵
